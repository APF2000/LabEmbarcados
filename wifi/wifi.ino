...
SoftwareSerial Serial1(4, 7); //PINOS QUE EMULAM A SERIAL, ONDE O PINO 6 É O RX E O PINO 7 É O TX
 
char ssid[] = "FONSECA"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "VIPDOCTOR33";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
